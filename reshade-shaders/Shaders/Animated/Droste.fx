...
namespace COBRA_DRO
{
    ...
    uniform float UI_OuterRing <
        ...
        ui_category  = COBRA_UTL_UI_GENERAL;
    >                = 1.00;
    uniform bool UI_Size_Anim <
	ui_category = "animated mask";
	ui_label = "UI_size animate";
	ui_type = "checkbox";
> = false;
    uniform float UI_Zoom <
        ...
        ui_category  = COBRA_UTL_UI_GENERAL;
    >                = 1.00;
        uniform bool UI_Zoom_Anim <
	ui_category = "animated mask";
	ui_label = "UI_Zoom animate";
	ui_type = "checkbox";
> = false;
    ...
    uniform float UI_Frequency <
        ...
        ui_category  = COBRA_UTL_UI_GENERAL;
    >                = 1.00;
    uniform bool UI_Frequency_Anim <
	ui_category = "animated mask";
	ui_label = "UI_Frequency animate";
	ui_type = "checkbox";
> = false;
    ...
    >                = 0.00;
        ...
        uniform bool UI_Center_x_Anim <
	ui_category = "animated mask";
	ui_label = "UI_center x animate";
	ui_type = "checkbox";
> = false;
    ...
    >                = 0.00;
            ...
            uniform bool UI_Center_y_Anim <
	ui_category = "animated mask";
	ui_label = "UI_center y   animate";
	ui_type = "checkbox";
> = false;
	...
	>;
	    ...
	    uniform float2 pingpong2 <
	source = "pingpong"; 
	min = 0.0; max = 10.0; 
	step = 0.5; 
	smoothing = 0.4; 
	>;
	    uniform float2 pingpong3 <
	source = "pingpong"; 
	min = 0.0; max = 1.0; 
	step = 0.3; 
	smoothing = 0.01; 
    ...
    void PS_Droste(vs2ps o, out float4 fragment : SV_Target)
    {
        ...
        const float zoom_speed = UI_Zoom_Anim ? pingpong2.x : 1;
        rcdist           = log(rcdist * (10 - UI_Zoom * zoom_speed)) * UI_Frequency;
        val             += rcdist;
        const float frequency_speed = UI_Frequency_Anim ?  pingpong.x * 5 : 1;
        val              = (exp(fmod(val, 1) / UI_Frequency*frequency_speed) - 1) / (rcp(o.uv.w) - 1);
        ...
        const float size_speed = UI_Size_Anim ? pingpong1.x * 3 : 1;
        const float INNER_RING = o.uv.w * UI_OuterRing * UI_Size_Anim;
        float real_scale       = lerp(INNER_RING, UI_OuterRing * UI_Size_Anim,val);
